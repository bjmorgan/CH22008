...
\begin{equation}
\frac{[\mathrm{C}^\ddagger]c^\circ}{[\mathrm{A}][\mathrm{B}]} = \frac{Q_{\mathrm{C}^\ddagger}}{Q_\mathrm{A}Q_\mathrm{B}}\left(\frac{k_\mathrm{B}T}{p^{\circ}}\right)
\end{equation}
