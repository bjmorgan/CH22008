...
Write down the rate equations for reactants and products based on the molecularity of the elementary process
Directly integrate these rate equations to obtain the corresponding integrated rate laws

For example, we have already seen how this works for first-order processes in Section \@ref{#simple-integrated-rate-laws).
