...
The treatment of internal molecular motions reveals additional subtlety in our theoretical framework. We have already seen contrasting examples of this effect in the unimolecular section: ethane decomposition showed unusually high pre-exponential factors due to enhanced internal rotation, whilst the Cope rearrangement showed lower values due to constrained rotation. To understand these effects systematically, consider the ethane molecule (C~2~H~6~), which exhibits two distinct types of motion around its C–C bond:
...
Figure \@ref(fig:fig-internal-rotation-levels) illustrates why internal rotation contributes more entropy than normal vibrations: the closely spaced energy levels mean many more states are thermally accessible. When such molecules form activated complexes, two scenarios arise, which we have already encountered:

1. **Restricted internal rotation** (as in the Cope rearrangement):
...
2. **Enhanced internal rotation** (as in ethane decomposition):
