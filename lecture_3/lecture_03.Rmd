...
The evolution from kinetic to thermodynamic control is best understood by visualising how reactions proceed. A reaction coordinate diagram shows how the energy of a molecular system changes as reactants transform into products. The horizontal axis—called the reaction coordinate—represents the progression of the reaction through changes in molecular geometry (bonds breaking and forming). The vertical axis shows the potential energy of the system.
